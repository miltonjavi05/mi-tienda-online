...
function DraggableWA(){
  ...
  const onClick=useCallback((e:React.MouseEvent)=>{if(moved.current){e.preventDefault();return;}trackLeadWhatsApp("boton_flotante");window.open(SOCIAL.whatsapp,"_blank","noreferrer");},[]);
...
const ProductCard=memo(function ProductCard({product,onClick,onBuyNow,fmtPrice}:{product:Product;onClick:()=>void;onBuyNow:()=>void;index:number;fmtPrice:(n:number)=>string}){
  return(
    <div className="pc" style={{WebkitTapHighlightColor:"transparent",touchAction:"manipulation",position:"relative",display:"flex",flexDirection:"column"}}>
      ...
      <button onClick={e=>{e.stopPropagation();onBuyNow();}} style={{background:"linear-gradient(180deg,#ffffff 0%,#ededed 100%)",color:"#080808",border:"none",padding:"6px 0",fontSize:9,fontWeight:900,letterSpacing:1.5,cursor:"pointer",fontFamily:"inherit",borderRadius:7,display:"flex",alignItems:"center",justifyContent:"center",gap:4,WebkitTapHighlightColor:"transparent",width:"100%",boxShadow:"0 3px 12px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,255,255,0.6)",marginBottom:"0.3rem"}}>
          <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
          COMPRAR AHORA
        </button>
        <button onClick={e=>{e.stopPropagation();trackLeadWhatsApp("finalizar_pedido");window.open(buildConsultUrl(product),"_blank","noreferrer");}} aria-label="Finalizar pedido por WhatsApp" style={{position:"relative",overflow:"hidden",background:"linear-gradient(155deg,rgba(37,211,102,0.16) 0%,rgba(20,20,20,0.95) 40%,rgba(10,10,10,0.98) 100%)",border:"1px solid rgba(76,222,128,0.35)",padding:"8px 0",cursor:"pointer",fontFamily:"inherit",borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",gap:7,WebkitTapHighlightColor:"transparent",width:"100%",backdropFilter:"blur(10px)",WebkitBackdropFilter:"blur(10px)",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.1), inset 0 0 0 1px rgba(37,211,102,0.08), 0 4px 16px rgba(37,211,102,0.22)"}}>
          <span style={{position:"absolute",inset:0,background:"linear-gradient(90deg,transparent 0%,rgba(76,222,128,0.1) 50%,transparent 100%)",backgroundSize:"200% 100%",animation:"badgeShimmer 3.2s ease infinite",pointerEvents:"none"}}/>
          <span style={{width:16,height:16,borderRadius:"50%",background:"linear-gradient(150deg,#4ade80,#22c55e)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,position:"relative",boxShadow:"0 0 6px rgba(74,222,128,0.5)"}}>
            <svg width="9" height="9" viewBox="0 0 24 24" fill="#080808"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
          </span>
          <span style={{fontSize:9,fontWeight:900,letterSpacing:1.8,color:"#fff",position:"relative"}}>FINALIZAR PEDIDO</span>
        </button>
    </div>
  );
});
    ...
    <div className="hc" style={{flexShrink:0,width:152,WebkitTapHighlightColor:"transparent",touchAction:"manipulation",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:"0.3rem"}}>
        ...
        <button
          ...
          style={{position:"relative",overflow:"hidden",background:"linear-gradient(155deg,rgba(37,211,102,0.16) 0%,rgba(20,20,20,0.95) 40%,rgba(10,10,10,0.98) 100%)",border:"1px solid rgba(76,222,128,0.35)",padding:"7px 0",cursor:"pointer",fontFamily:"inherit",borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",gap:6,WebkitTapHighlightColor:"transparent",width:"100%",backdropFilter:"blur(10px)",WebkitBackdropFilter:"blur(10px)",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.1), inset 0 0 0 1px rgba(37,211,102,0.08), 0 4px 14px rgba(37,211,102,0.22)"}}
        >
          <span style={{position:"absolute",inset:0,background:"linear-gradient(90deg,transparent 0%,rgba(76,222,128,0.1) 50%,transparent 100%)",backgroundSize:"200% 100%",animation:"badgeShimmer 3.2s ease infinite",pointerEvents:"none"}}/>
          <span style={{width:14,height:14,borderRadius:"50%",background:"linear-gradient(150deg,#4ade80,#22c55e)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,position:"relative",boxShadow:"0 0 5px rgba(74,222,128,0.5)"}}>
            <svg width="8" height="8" viewBox="0 0 24 24" fill="#080808"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
          </span>
          <span style={{fontSize:8,fontWeight:900,letterSpacing:1.5,color:"#fff",position:"relative"}}>FINALIZAR PEDIDO</span>
        </button>
      </div>
    </div>
  );
      ...
      <div style={{maxWidth:1100,margin:"0 auto"}}>
        <div className="fg" style={{display:"grid",gap:"2rem",marginBottom:"2rem"}}>
          ...
          <div>
            ...
            <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noreferrer" style={{display:"inline-flex",alignItems:"center",gap:"0.45rem",background:"#0d1e0d",color:"#4caf50",padding:"0.55rem 0.9rem",borderRadius:8,fontSize:11,fontWeight:700,textDecoration:"none",marginBottom:"0.75rem",border:"1px solid #162516"}} data-fokus-tracked="true" onClick={()=>trackLeadWhatsApp("footer_contacto")}><IcWA s={12} c="#4caf50"/> WhatsApp</a>
