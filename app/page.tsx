    ...
    <div className="pc" style={{WebkitTapHighlightColor:"transparent",touchAction:"manipulation",position:"relative"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:"0.35rem"}}>
        ...
        <div style={{display:"flex",gap:"0.4rem"}}>
          ...
          <button onClick={e=>{e.stopPropagation();window.open(buildConsultUrl(product),"_blank","noreferrer");}} aria-label="Finalizar pedido por WhatsApp" title="Finalizar pedido por WhatsApp" style={{background:"#111",border:"1px solid rgba(255,255,255,0.18)",padding:"7px 8px",cursor:"pointer",fontFamily:"inherit",borderRadius:7,display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",gap:5,WebkitTapHighlightColor:"transparent",flex:1}}>
            <svg width="11" height="11" viewBox="0 0 24 24" fill="#25D366" style={{flexShrink:0}}><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
            <span style={{fontSize:8,fontWeight:800,letterSpacing:0.5,lineHeight:1,color:"#aaa",whiteSpace:"nowrap"}}>PEDIDO</span>
          </button>
        </div>
      </div>
    </div>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:"0.3rem"}}>
        ...
        <div style={{display:"flex",gap:"0.3rem"}}>
          <button
            ...
            style={{background:"rgba(255,255,255,0.03)",color:"#777",border:"1px solid rgba(255,255,255,0.12)",padding:"6px 0",fontSize:8,fontWeight:700,letterSpacing:0.8,cursor:"pointer",fontFamily:"inherit",borderRadius:7,display:"flex",alignItems:"center",justifyContent:"center",gap:3,WebkitTapHighlightColor:"transparent",flex:1}}
          >
          ...
          <button
            ...
            style={{position:"relative",overflow:"hidden",background:"linear-gradient(135deg,rgba(255,255,255,0.10) 0%,rgba(255,255,255,0.04) 60%,rgba(255,255,255,0.08) 100%)",border:"1px solid rgba(255,255,255,0.18)",padding:"6px 7px",cursor:"pointer",fontFamily:"inherit",borderRadius:7,display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",gap:4,WebkitTapHighlightColor:"transparent",flex:1,backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.18), 0 2px 12px rgba(0,0,0,0.5)"}}
          >
            <span style={{position:"absolute",top:0,left:"-60%",width:"40%",height:"100%",background:"linear-gradient(115deg,transparent,rgba(255,255,255,0.18),transparent)",transform:"skewX(-18deg)",pointerEvents:"none",animation:"shimmer 3s ease infinite"}}/>
            <span style={{position:"absolute",top:0,left:0,right:0,height:"1px",background:"linear-gradient(90deg,transparent,rgba(255,255,255,0.35),transparent)",pointerEvents:"none"}}/>
            <svg width="10" height="10" viewBox="0 0 24 24" fill="#25D366" style={{flexShrink:0}}><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
            <span style={{position:"relative",fontSize:7,fontWeight:800,letterSpacing:0.8,lineHeight:1,color:"rgba(255,255,255,0.75)",whiteSpace:"nowrap"}}>FINALIZAR PEDIDO</span>
          </button>
        </div>
      </div>
    </div>
  ...
  setTimeout(()=>{
    ...
    firstInput?.scrollIntoView({behavior:"smooth",block:"center"});
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:6,marginBottom:"0.65rem",padding:"0.5rem",background:"rgba(255,255,255,0.02)",borderRadius:8,border:"1px solid #1e1e1e"}}><span style={{fontSize:10}}>⚡</span><p style={{margin:0,fontSize:10,color:"#555",fontWeight:700,letterSpacing:0.5}}>Tu pedido se confirma por WhatsApp en menos de 5 minutos</p></div>
              <button onClick={handleSendOrder} style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"0.75rem",width:"100%",marginTop:"0",background:canSendOrder?"linear-gradient(135deg,#fff 0%,#e8e8e8 100%)":"#1a1a1a",color:canSendOrder?"#080808":"#444",padding:"1.2rem",fontWeight:900,letterSpacing:2,fontSize:12,border:`1px solid ${canSendOrder?"transparent":"#2a2a2a"}`,borderRadius:12,cursor:canSendOrder?"pointer":"not-allowed",fontFamily:"inherit",transition:"all 0.25s",boxShadow:canSendOrder?"0 4px 20px rgba(255,255,255,0.15)":"none"}}>
              {canSendOrder&&<IcWA s={18} c="#080808"/>}
            ...
            <div style={{display:"flex",justifyContent:"center",gap:"1.5rem",marginTop:"1rem",marginBottom:"0.25rem",flexWrap:"wrap"}}>{[{i:"🔒",t:"Pago seguro"},{i:"📦",t:"Envío a todo el país"},{i:"⭐",t:"3.000+ clientes"}].map(({i,t})=>(<div key={t} style={{display:"flex",alignItems:"center",gap:4}}><span style={{fontSize:10}}>{i}</span><span style={{fontSize:9,color:"#333",fontWeight:700,letterSpacing:0.5}}>{t.toUpperCase()}</span></div>))}</div>
              <button onClick={()=>{setMainView("shop");setShopFilter("TODO");}} style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"0.5rem",width:"100%",marginTop:"0.5rem",background:"rgba(255,255,255,0.03)",color:"#555",border:"1px solid rgba(255,255,255,0.07)",padding:"0.85rem",fontSize:10,fontWeight:800,letterSpacing:1.5,cursor:"pointer",fontFamily:"inherit",WebkitTapHighlightColor:"transparent",borderRadius:10,backdropFilter:"blur(8px)",WebkitBackdropFilter:"blur(8px)"}}>
