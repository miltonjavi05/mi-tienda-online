  ...
  return(
    <div className="pc" style={{WebkitTapHighlightColor:"transparent",touchAction:"manipulation",position:"relative"}}>
      ...
      <div style={{display:"flex",gap:"0.4rem"}}>
          <button onClick={e=>{e.stopPropagation();onBuyNow();}} style={{background:"linear-gradient(180deg,#ffffff 0%,#ededed 100%)",color:"#080808",border:"none",padding:"6px 0",fontSize:9,fontWeight:900,letterSpacing:1.5,cursor:"pointer",fontFamily:"inherit",borderRadius:7,display:"flex",alignItems:"center",justifyContent:"center",gap:4,WebkitTapHighlightColor:"transparent",flex:2,boxShadow:"0 3px 12px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,255,255,0.6)"}}>
            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
            COMPRAR
          </button>
          <button onClick={e=>{e.stopPropagation();onClick();}} style={{background:"rgba(255,255,255,0.03)",color:"#999",border:"1px solid rgba(255,255,255,0.14)",padding:"6px 0",fontSize:9,fontWeight:700,letterSpacing:1,cursor:"pointer",fontFamily:"inherit",borderRadius:7,display:"flex",alignItems:"center",justifyContent:"center",gap:4,WebkitTapHighlightColor:"transparent",flex:2}}>
          ...
          <button onClick={e=>{e.stopPropagation();window.open(buildConsultUrl(product),"_blank","noreferrer");}} aria-label="Finalizar pedido por WhatsApp" style={{position:"relative",overflow:"hidden",background:"linear-gradient(150deg, rgba(255,255,255,0.20) 0%, rgba(255,255,255,0.05) 55%, rgba(255,255,255,0.16) 100%)",border:"1px solid rgba(255,255,255,0.3)",padding:"6px 0",cursor:"pointer",fontFamily:"inherit",borderRadius:7,display:"flex",alignItems:"center",justifyContent:"center",gap:3,WebkitTapHighlightColor:"transparent",flex:3,backdropFilter:"blur(6px)",WebkitBackdropFilter:"blur(6px)",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.35), 0 2px 10px rgba(0,0,0,0.4)"}}>
            ...
            <span style={{fontSize:8,fontWeight:800,letterSpacing:0.8,color:"#fff"}}>FINALIZAR</span>
          </button>
        </div>
    </div>
  );
      ...
      <div style={{display:"flex",flexDirection:"column",gap:"0.3rem"}}>
        <div style={{display:"flex",gap:"0.3rem"}}>
          <button
            ...
            style={{background:"linear-gradient(180deg,#ffffff 0%,#ededed 100%)",color:"#080808",border:"none",padding:"5px 0",fontSize:8,fontWeight:900,letterSpacing:1,cursor:"pointer",fontFamily:"inherit",borderRadius:7,display:"flex",alignItems:"center",justifyContent:"center",gap:3,WebkitTapHighlightColor:"transparent",flex:2,boxShadow:"0 3px 10px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,255,255,0.6)"}}
          >
          ...
          <button
            ...
            style={{background:"rgba(255,255,255,0.03)",color:"#777",border:"1px solid rgba(255,255,255,0.12)",padding:"5px 0",fontSize:8,fontWeight:700,letterSpacing:0.8,cursor:"pointer",fontFamily:"inherit",borderRadius:7,display:"flex",alignItems:"center",justifyContent:"center",gap:3,WebkitTapHighlightColor:"transparent",flex:2}}
          >
          ...
          <button
            ...
            style={{position:"relative",overflow:"hidden",background:"linear-gradient(150deg, rgba(255,255,255,0.20) 0%, rgba(255,255,255,0.05) 55%, rgba(255,255,255,0.16) 100%)",border:"1px solid rgba(255,255,255,0.3)",padding:"5px 0",cursor:"pointer",fontFamily:"inherit",borderRadius:7,display:"flex",alignItems:"center",justifyContent:"center",gap:3,WebkitTapHighlightColor:"transparent",flex:3,backdropFilter:"blur(6px)",WebkitBackdropFilter:"blur(6px)",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.35), 0 2px 8px rgba(0,0,0,0.4)"}}
          >
            <span style={{position:"absolute",top:0,left:"-40%",width:"35%",height:"100%",background:"linear-gradient(115deg,transparent,rgba(255,255,255,0.45),transparent)",transform:"skewX(-18deg)",pointerEvents:"none"}}/>
            <svg width="9" height="9" viewBox="0 0 24 24" fill="#fff"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
            <span style={{fontSize:7,fontWeight:800,letterSpacing:0.8,color:"#fff"}}>FINALIZAR</span>
          </button>
        </div>
      </div>
    </div>
