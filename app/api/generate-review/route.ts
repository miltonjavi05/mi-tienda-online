...
const OPENING_STYLES = [
  ...
  "empieza contando que había comprado algo parecido antes en otra tienda y no le gustó la calidad, y que aquí quedó muchísimo mejor",
...
const COMMENT_FOCUS_STYLES = [
  ...
  "concéntrate en comparar el producto con uno similar que compró antes en otra tienda (fuera de aquí) que no le gustó o no cumplió, y explica con claridad por qué el de esta tienda está muchísimo mejor (puedes usar frases tipo '100% recomendados' o calificar informalmente el producto, ej: 'esto está 20/10')",
