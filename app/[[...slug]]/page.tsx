              ...
              getVisCats().map(cat=>{
                ...
                return(
                  <ScrollFocusSection key={cat} style={{marginBottom:"0.55rem"}}>
                    ...
                    <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:6,margin:"0.85rem auto 0",width:"fit-content",background:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:20,padding:"0.32rem 0.9rem",backdropFilter:"blur(6px)",WebkitBackdropFilter:"blur(6px)",position:"relative",zIndex:2}}>
