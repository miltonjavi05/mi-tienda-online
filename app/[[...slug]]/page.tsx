      ...
      {mainView==="fokus"&&(
        <main className="pv" style={{paddingTop:navH,background:C.bg}}>
          <div style={{maxWidth:760,margin:"0 auto",padding:"4rem 1.5rem 0",textAlign:"center",animation:"slideUp 0.5s ease"}}>
            ...
            <p style={{fontSize:13,color:"#666",lineHeight:1.7,maxWidth:420,margin:"0 auto 1.25rem"}}>
              Fokus Accesorios es la tienda en línea oficial de accesorios para caballero en Venezuela: lentes de sol, relojes, collares, pulseras, anillos, aretes y billeteras, con envíos a todo el país.
            </p>
            <p style={{fontSize:14,color:"#444",lineHeight:1.7,maxWidth:300,margin:"0 auto 1rem"}}>Cada detalle +<br/>Calidad, diseño y actitud.</p>
            <p style={{fontSize:13,color:"#555",lineHeight:1.8,maxWidth:440,margin:"0 auto 2rem"}}>Fokus Accesorios es una aplicación web de comercio electrónico (tienda en línea) donde los usuarios pueden ver y comprar lentes de sol, relojes, pulseras, collares, aretes, anillos y billeteras en Venezuela. Fokus Accesorios ofrece inicio de sesión con Google y Facebook para que los usuarios puedan crear una cuenta, guardar su nombre y foto de perfil, y agilizar el proceso de compra. Los pedidos se confirman de forma manual a través de WhatsApp con el equipo de Fokus Accesorios.</p>
