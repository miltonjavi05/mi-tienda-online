      ...
      <nav ref={navRef} style={{position:"fixed",top:0,left:0,right:0,zIndex:200,background:"rgba(8,8,8,0.96)",borderBottom:"1px solid #161616",backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)"}}>
        ...
        <div style={{borderTop:"1px solid #161616",padding:"0 1rem",height:36,display:"flex",alignItems:"center",justifyContent:"space-between",gap:"0.5rem"}}>
          ...
          <button
            ...
            style={{display:"flex",alignItems:"center",gap:5,background:showBs?"rgba(255,255,255,0.16)":"rgba(0,0,0,0.25)",color:"#fff",border:`1px solid ${showBs?"rgba(255,255,255,0.4)":"rgba(255,255,255,0.15)"}`,borderRadius:20,padding:"4px 14px",fontSize:10,fontWeight:900,letterSpacing:1.5,cursor:"pointer",fontFamily:"inherit",flexShrink:0,transition:"all 0.2s ease",WebkitTapHighlightColor:"transparent",touchAction:"manipulation",backdropFilter:"blur(12px) saturate(1.5)",WebkitBackdropFilter:"blur(12px) saturate(1.5)"}}
          >
